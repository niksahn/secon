...
data object AdminAuthUi : Screen {
    ...
    override fun Content() {
        ...
        val viewModel = koinScreenModel<AdminAuthViewModel>()
        ...
        Ui(
            ...
            onGroupeLogin = { navigator.push(AuthUi)}
        )
    }
        ...
        Scaffold {
            Box(
                ...
                Column(
                    ...
                    Spacer(16.dp)
                    Column(
                        Modifier.clickable(onClick = onGroupeLogin).fillMaxWidth(),
                        horizontalAlignment = Alignment.CenterHorizontally,
                    ) {
                        HorizontalDivider()
                        Spacer(8.dp)
                        Text(text = "Войти как бригада")
                    }
                }
            }
        }
